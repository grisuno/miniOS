...
- Symbols:
  ...
  - `net_icmp_rx` (function, line 321) `static void net_icmp_rx(const unsigned char *ip, unsigned len)`
  - `net_ping` (function, line 350) `static int net_ping(const unsigned char ip[4])`
  - `net_sock_alloc` (function, line 402) `static struct net_tcp_sock *net_sock_alloc(void)`
  - `net_sock_index` (function, line 415) `static int net_sock_index(const struct net_tcp_sock *s)`
  - `net_tcp_checksum` (function, line 424) `static unsigned short net_tcp_checksum(const unsigned char *src, const unsigned char *dst,
      ...`
  - `net_udp_checksum_ok` (function, line 440) `static int net_udp_checksum_ok(const unsigned char *src, const unsigned char *dst,
              ...`
  - `net_tcp_xmit` (function, line 455) `static int net_tcp_xmit(struct net_tcp_sock *s, unsigned flags,
                        const uns...`
  - `net_tcp_rx` (function, line 487) `static void net_tcp_rx(const unsigned char *ip, unsigned len)`
  - `net_tcp_connect_into` (function, line 573) `static int net_tcp_connect_into(struct net_tcp_sock *s, const unsigned char ip[4],
              ...`
  - `net_tcp_send` (function, line 600) `static int net_tcp_send(struct net_tcp_sock *s, const char *buf, int len)`
  - `net_tcp_recv` (function, line 626) `static int net_tcp_recv(struct net_tcp_sock *s, char *buf, int len)`
  - `net_tcp_close` (function, line 663) `static void net_tcp_close(struct net_tcp_sock *s)`
  - `net_rx_handle_frame` (function, line 683) `void net_rx_handle_frame(const unsigned char *frame, unsigned len)`
  - `net_open` (function, line 741) `int net_open(void)`
  - `net_connect` (function, line 747) `int net_connect(const char *host, unsigned short port)`
  - `net_send` (function, line 756) `int net_send(int fd, const char *buf, int len)`
  - `net_recv` (function, line 761) `int net_recv(int fd, char *buf, int len)`
  - `net_recv_timeout` (function, line 766) `int net_recv_timeout(int fd, char *buf, int len, unsigned long timeout_ms)`
  - `net_close` (function, line 771) `void net_close(int fd)`
  - `net_sys_socket` (function, line 780) `long net_sys_socket(long a1, long a2, long a3)`
  - `net_sys_connect` (function, line 789) `long net_sys_connect(long fd, long sockaddr, long addrlen)`
  - `net_sys_sendto` (function, line 802) `long net_sys_sendto(long fd, long buf, long len, long flags, long to, long tolen)`
  - `net_sys_recvfrom` (function, line 812) `long net_sys_recvfrom(long fd, long buf, long len, long flags, long from, long fromlen)`
  - `net_sys_shutdown` (function, line 822) `long net_sys_shutdown(long fd, long how)`
  - `net_sys_close` (function, line 829) `long net_sys_close(long fd)`
  - `net_sys_poll` (function, line 836) `long net_sys_poll(long fds, long nfds, long timeout_ms)`
  - `net_sys_dns` (function, line 873) `long net_sys_dns(long host)`
  - `net_parse_ip` (function, line 883) `static int net_parse_ip(const char *text, unsigned char ip[4])`
  - `net_cmd_status` (function, line 908) `void net_cmd_status(void)`
  - `net_get_addrs` (function, line 926) `void net_get_addrs(unsigned char mac_out[NET_ETH_ALEN], unsigned char ip_out[4])`
  - `net_cmd_ping` (function, line 931) `void net_cmd_ping(const char *ip_text)`
  - `net_cmd_dns` (function, line 942) `void net_cmd_dns(const char *host)`
  - `net_register_symbols` (function, line 955) `void net_register_symbols(void)`
  - `net_init` (function, line 963) `void net_init(void)`
  ...
  - `kfree` (function, line 313) `out: kfree(q);`
  - `kmemmove` (function, line 532) `kmemmove(s->rx, s->rx + s->rx_tail, s->rx_head - s->rx_tail);`
  - `net_tcp_recv_deadline` (function, line 769) `return net_tcp_recv_deadline(&net_sockets[fd], buf, len, timeout_ms);`
  - `tls_free_fd` (function, line 832) `tls_free_fd((int)(fd - NET_FD_BASE));`
  - `vga_puts` (function, line 912) `vga_puts("net: no rtl8139 found\n");`
  - `rtl_counters` (function, line 915) `rtl_counters(&tx_frames, &rx_frames);`
  - `kprintf` (function, line 916) `kprintf("rtl8139 iobase 0x%x\n", rtl_iobase());`
  - `k_register_symbol` (function, line 957) `k_register_symbol("net_open", (void *)net_open);`
  - `rtl_init` (function, line 965) `rtl_init();`
  - `rtl_get_mac` (function, line 966) `rtl_get_mac(net_mac);`
  - `NET_TCP_CLOSED` (macro, line 373) `#define NET_TCP_CLOSED`
