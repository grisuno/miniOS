...
- Symbols:
  ...
  - `file_preview_blit` (function, line 382) `static void file_preview_blit(int ox, int oy)`
  - `file_spawn_visible` (function, line 404) `static long file_spawn_visible(const char *tool, int argc, const char **argv,
                   ...`
  - `file_open_text` (function, line 427) `static void file_open_text(const char *path)`
  - `file_run_shell` (function, line 438) `static void file_run_shell(const char *path)`
  - `file_activate` (function, line 477) `static void file_activate(const char *dir, const char *name)`
  - `file_ui_build` (function, line 508) `static void file_ui_build(struct nk_context *ctx)`
  - `file_selftest` (function, line 607) `static int file_selftest(void)`
  - `file_gui_run` (function, line 761) `static void file_gui_run(void)`
  - `main` (function, line 819) `int main(int argc, char **argv)`
