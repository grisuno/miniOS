...
- Symbols:
  ...
  - `MINIOS_DOOM_BACKBUF_ADDR` (macro, line 104)
  - `MINIOS_DOOM_W` (macro, line 105)
  - `MINIOS_DOOM_H` (macro, line 106)
  - `MINIOS_FB_ADDR` (macro, line 107)
  - `MINIOS_NK_BACKBUF_ADDR` (macro, line 108)
  - `MINIOS_NK_W` (macro, line 109)
  - `MINIOS_NK_H` (macro, line 110)
  - `MINIOS_HEAP_BASE` (macro, line 115)
  - `MINIOS_HEAP_SIZE` (macro, line 116)
  - `MINIOS_FB_WIDTH_MAX` (macro, line 121)
  - `MINIOS_FB_HEIGHT_MAX` (macro, line 122)
  - `MINIOS_SYS_READ` (macro, line 140)
  - `MINIOS_SYS_WRITE` (macro, line 141)
  - `MINIOS_SYS_OPEN` (macro, line 142)
  - `MINIOS_SYS_CLOSE` (macro, line 143)
  - `MINIOS_SYS_FSTAT` (macro, line 144)
  - `MINIOS_SYS_POLL` (macro, line 145)
  - `MINIOS_SYS_LSEEK` (macro, line 146)
  - `MINIOS_SYS_MMAP` (macro, line 147)
  - `MINIOS_SYS_MPROTECT` (macro, line 148)
  - `MINIOS_SYS_MUNMAP` (macro, line 149)
  - `MINIOS_SYS_BRK` (macro, line 150)
  - `MINIOS_SYS_RT_SIGACTION` (macro, line 151)
  - `MINIOS_SYS_RT_SIGPROCMASK` (macro, line 152)
  - `MINIOS_SYS_IOCTL` (macro, line 153)
  - `MINIOS_SYS_WRITEV` (macro, line 154)
  - `MINIOS_SYS_ACCESS` (macro, line 155)
  - `MINIOS_SYS_SCHED_YIELD` (macro, line 156)
  - `MINIOS_SYS_GETPID` (macro, line 157)
  - `MINIOS_SYS_SOCKET` (macro, line 158)
  - `MINIOS_SYS_CONNECT` (macro, line 159)
  - `MINIOS_SYS_SENDTO` (macro, line 160)
  - `MINIOS_SYS_RECVFROM` (macro, line 161)
  - `MINIOS_SYS_SHUTDOWN` (macro, line 162)
  - `MINIOS_SYS_FORK` (macro, line 163)
  - `MINIOS_SYS_VFORK` (macro, line 164)
  - `MINIOS_SYS_EXECVE` (macro, line 165)
  - `MINIOS_SYS_EXIT` (macro, line 166)
  - `MINIOS_SYS_WAIT4` (macro, line 167)
  - `MINIOS_SYS_KILL` (macro, line 168)
  - `MINIOS_SYS_UNLINK` (macro, line 169)
  - `MINIOS_SYS_READLINK` (macro, line 170)
  - `MINIOS_SYS_GETTID` (macro, line 171)
  - `MINIOS_SYS_FLOCK` (macro, line 172)
  - `MINIOS_SYS_GETCWD` (macro, line 173)
  - `MINIOS_SYS_GETTIMEOFDAY` (macro, line 174)
  - `MINIOS_SYS_ARCH_PRCTL` (macro, line 175)
  - `MINIOS_SYS_OPENAT` (macro, line 176)
  - `MINIOS_SYS_NEWFSTATAT` (macro, line 177)
  - `MINIOS_SYS_READLINK` (macro, line 178)
  - `MINIOS_SYS_STATX` (macro, line 179)
  - `MINIOS_SYS_SET_MEMPOLICY` (macro, line 180)
  - `MINIOS_SYS_SET_ROBUST_LIST` (macro, line 181)
  - `MINIOS_SYS_PRLIMIT64` (macro, line 182)
  - `MINIOS_SYS_GETRANDOM` (macro, line 183)
  - `MINIOS_SYS_RSEQ` (macro, line 184)
  - `MINIOS_SYS_EXIT_GROUP` (macro, line 185)
  - `MINIOS_SYS_SET_TID_ADDRESS` (macro, line 186)
  - `MINIOS_SYS_CLOCK_GETTIME` (macro, line 187)
  - `MINIOS_SYS_TGKILL` (macro, line 188)
  - `MINIOS_SYS_DNS` (macro, line 191)
  - `MINIOS_SYS_TLS_HANDSHAKE` (macro, line 192)
  - `MINIOS_SYS_TLS_SEND` (macro, line 193)
  - `MINIOS_SYS_TLS_RECV` (macro, line 194)
  - `MINIOS_SYS_TIME` (macro, line 195)
  - `MINIOS_SYS_KBD` (macro, line 196)
  - `MINIOS_SYS_PALETTE` (macro, line 197)
  - `MINIOS_SYS_KBD_RAW` (macro, line 198)
  - `MINIOS_SYS_VGA_MODE` (macro, line 199)
  - `MINIOS_SYS_PCSPK_INIT` (macro, line 200)
  - `MINIOS_SYS_PCSPK_TONE` (macro, line 201)
  - `MINIOS_SYS_DOOM_FRAME` (macro, line 202)
  - `MINIOS_SYS_RTC` (macro, line 203)
  - `MINIOS_SYS_FB_INFO` (macro, line 204)
  - `MINIOS_SYS_PCSPK_VOL` (macro, line 205)
  - `MINIOS_SYS_SPAWN` (macro, line 206)
  - `MINIOS_SYS_LZ4_COMPRESS` (macro, line 207)
  - `MINIOS_SYS_LZ4_DECOMPRESS` (macro, line 208)
  - `MINIOS_SYS_MOUSE` (macro, line 209)
  - `MINIOS_SYS_NK_FRAME` (macro, line 210)
  - `MINIOS_SYS_SB16_OPEN` (macro, line 211)
  - `MINIOS_SYS_SB16_SUBMIT` (macro, line 212)
  - `MINIOS_SYS_GFX_SET_TITLE` (macro, line 213)
  - `MINIOS_SYS_SB16_PUMP` (macro, line 214)
  - `MINIOS_SYS_SB16_STREAM_OPEN` (macro, line 215)
  - `MINIOS_SYS_SB16_STREAM_CLOSE` (macro, line 216)
  - `MINIOS_SYS_SB16_STREAM_SUBMIT` (macro, line 217)
  - `MINIOS_SYS_SB16_STREAM_VOLUME` (macro, line 218)
  - `MINIOS_SYS_THREAD_SPAWN` (macro, line 219)
  - `MINIOS_SYS_FUTEX_WAIT` (macro, line 220)
  - `MINIOS_SYS_FUTEX_WAKE` (macro, line 221)
  - `MINIOS_SYS_SUBMIT_BATCH` (macro, line 222)
  - `MINIOS_SYS_CLONE` (macro, line 223)
  - `SYS_TIME_MS` (macro, line 227)
  - `SYS_PALETTE` (macro, line 228)
  - `SYS_PCSPK_INIT` (macro, line 229)
  - `SYS_PCSPK_TONE` (macro, line 230)
  - `SYS_RTC` (macro, line 231)
  - `SYS_FB_INFO` (macro, line 232)
  - `SYS_PCSPK_VOL` (macro, line 233)
  - `SYS_SPAWN` (macro, line 234)
  - `SYS_TIME` (macro, line 235)
  - `SYS_WRITE` (macro, line 236)
  - `MINIOS_EABI_MISMATCH` (macro, line 239)
