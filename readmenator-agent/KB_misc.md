...
- Symbols:
  ...
  - `MINIOS_USER_LOAD_BASE` (macro, line 90) `#define MINIOS_USER_LOAD_BASE`
  - `MINIOS_USER_LOAD_END` (macro, line 91) `#define MINIOS_USER_LOAD_END`
  - `MINIOS_USER_STACK_SIZE` (macro, line 92) `#define MINIOS_USER_STACK_SIZE`
  - `MINIOS_USER_STACK_TOP` (macro, line 93) `#define MINIOS_USER_STACK_TOP`
  - `MINIOS_USER_STACK_BASE` (macro, line 94) `#define MINIOS_USER_STACK_BASE`
  - `MINIOS_USER_BRK_END` (macro, line 95) `#define MINIOS_USER_BRK_END`
  - `MINIOS_DOOM_BACKBUF_ADDR` (macro, line 112) `#define MINIOS_DOOM_BACKBUF_ADDR`
  - `MINIOS_DOOM_W` (macro, line 113) `#define MINIOS_DOOM_W`
  - `MINIOS_DOOM_H` (macro, line 114) `#define MINIOS_DOOM_H`
  - `MINIOS_FB_ADDR` (macro, line 115) `#define MINIOS_FB_ADDR`
  - `MINIOS_NK_BACKBUF_ADDR` (macro, line 116) `#define MINIOS_NK_BACKBUF_ADDR`
  - `MINIOS_NK_W` (macro, line 117) `#define MINIOS_NK_W`
  - `MINIOS_NK_H` (macro, line 118) `#define MINIOS_NK_H`
  - `MINIOS_HEAP_BASE` (macro, line 123) `#define MINIOS_HEAP_BASE`
  - `MINIOS_HEAP_SIZE` (macro, line 124) `#define MINIOS_HEAP_SIZE`
  - `MINIOS_FB_WIDTH_MAX` (macro, line 129) `#define MINIOS_FB_WIDTH_MAX`
  - `MINIOS_FB_HEIGHT_MAX` (macro, line 130) `#define MINIOS_FB_HEIGHT_MAX`
  - `MINIOS_SYS_READ` (macro, line 148) `#define MINIOS_SYS_READ`
  - `MINIOS_SYS_WRITE` (macro, line 149) `#define MINIOS_SYS_WRITE`
  - `MINIOS_SYS_OPEN` (macro, line 150) `#define MINIOS_SYS_OPEN`
  - `MINIOS_SYS_CLOSE` (macro, line 151) `#define MINIOS_SYS_CLOSE`
  - `MINIOS_SYS_FSTAT` (macro, line 152) `#define MINIOS_SYS_FSTAT`
  - `MINIOS_SYS_POLL` (macro, line 153) `#define MINIOS_SYS_POLL`
  - `MINIOS_SYS_LSEEK` (macro, line 154) `#define MINIOS_SYS_LSEEK`
  - `MINIOS_SYS_MMAP` (macro, line 155) `#define MINIOS_SYS_MMAP`
  - `MINIOS_SYS_MPROTECT` (macro, line 156) `#define MINIOS_SYS_MPROTECT`
  - `MINIOS_SYS_MUNMAP` (macro, line 157) `#define MINIOS_SYS_MUNMAP`
  - `MINIOS_SYS_BRK` (macro, line 158) `#define MINIOS_SYS_BRK`
  - `MINIOS_SYS_RT_SIGACTION` (macro, line 159) `#define MINIOS_SYS_RT_SIGACTION`
  - `MINIOS_SYS_RT_SIGPROCMASK` (macro, line 160) `#define MINIOS_SYS_RT_SIGPROCMASK`
  - `MINIOS_SYS_IOCTL` (macro, line 161) `#define MINIOS_SYS_IOCTL`
  - `MINIOS_SYS_WRITEV` (macro, line 162) `#define MINIOS_SYS_WRITEV`
  - `MINIOS_SYS_ACCESS` (macro, line 163) `#define MINIOS_SYS_ACCESS`
  - `MINIOS_SYS_SCHED_YIELD` (macro, line 164) `#define MINIOS_SYS_SCHED_YIELD`
  - `MINIOS_SYS_GETPID` (macro, line 165) `#define MINIOS_SYS_GETPID`
  - `MINIOS_SYS_SOCKET` (macro, line 166) `#define MINIOS_SYS_SOCKET`
  - `MINIOS_SYS_CONNECT` (macro, line 167) `#define MINIOS_SYS_CONNECT`
  - `MINIOS_SYS_SENDTO` (macro, line 168) `#define MINIOS_SYS_SENDTO`
  - `MINIOS_SYS_RECVFROM` (macro, line 169) `#define MINIOS_SYS_RECVFROM`
  - `MINIOS_SYS_SHUTDOWN` (macro, line 170) `#define MINIOS_SYS_SHUTDOWN`
  - `MINIOS_SYS_FORK` (macro, line 171) `#define MINIOS_SYS_FORK`
  - `MINIOS_SYS_VFORK` (macro, line 172) `#define MINIOS_SYS_VFORK`
  - `MINIOS_SYS_EXECVE` (macro, line 173) `#define MINIOS_SYS_EXECVE`
  - `MINIOS_SYS_EXIT` (macro, line 174) `#define MINIOS_SYS_EXIT`
  - `MINIOS_SYS_WAIT4` (macro, line 175) `#define MINIOS_SYS_WAIT4`
  - `MINIOS_SYS_KILL` (macro, line 176) `#define MINIOS_SYS_KILL`
  - `MINIOS_SYS_UNLINK` (macro, line 177) `#define MINIOS_SYS_UNLINK`
  - `MINIOS_SYS_READLINK` (macro, line 178) `#define MINIOS_SYS_READLINK`
  - `MINIOS_SYS_GETTID` (macro, line 179) `#define MINIOS_SYS_GETTID`
  - `MINIOS_SYS_FLOCK` (macro, line 180) `#define MINIOS_SYS_FLOCK`
  - `MINIOS_SYS_GETCWD` (macro, line 181) `#define MINIOS_SYS_GETCWD`
  - `MINIOS_SYS_GETTIMEOFDAY` (macro, line 182) `#define MINIOS_SYS_GETTIMEOFDAY`
  - `MINIOS_SYS_ARCH_PRCTL` (macro, line 183) `#define MINIOS_SYS_ARCH_PRCTL`
  - `MINIOS_SYS_OPENAT` (macro, line 184) `#define MINIOS_SYS_OPENAT`
  - `MINIOS_SYS_NEWFSTATAT` (macro, line 185) `#define MINIOS_SYS_NEWFSTATAT`
  - `MINIOS_SYS_READLINK` (macro, line 186) `#define MINIOS_SYS_READLINK`
  - `MINIOS_SYS_STATX` (macro, line 187) `#define MINIOS_SYS_STATX`
  - `MINIOS_SYS_SET_MEMPOLICY` (macro, line 188) `#define MINIOS_SYS_SET_MEMPOLICY`
  - `MINIOS_SYS_SET_ROBUST_LIST` (macro, line 189) `#define MINIOS_SYS_SET_ROBUST_LIST`
  - `MINIOS_SYS_PRLIMIT64` (macro, line 190) `#define MINIOS_SYS_PRLIMIT64`
  - `MINIOS_SYS_GETRANDOM` (macro, line 191) `#define MINIOS_SYS_GETRANDOM`
  - `MINIOS_SYS_RSEQ` (macro, line 192) `#define MINIOS_SYS_RSEQ`
  - `MINIOS_SYS_EXIT_GROUP` (macro, line 193) `#define MINIOS_SYS_EXIT_GROUP`
  - `MINIOS_SYS_SET_TID_ADDRESS` (macro, line 194) `#define MINIOS_SYS_SET_TID_ADDRESS`
  - `MINIOS_SYS_CLOCK_GETTIME` (macro, line 195) `#define MINIOS_SYS_CLOCK_GETTIME`
  - `MINIOS_SYS_TGKILL` (macro, line 196) `#define MINIOS_SYS_TGKILL`
  - `MINIOS_SYS_DNS` (macro, line 199) `#define MINIOS_SYS_DNS`
  - `MINIOS_SYS_TLS_HANDSHAKE` (macro, line 200) `#define MINIOS_SYS_TLS_HANDSHAKE`
  - `MINIOS_SYS_TLS_SEND` (macro, line 201) `#define MINIOS_SYS_TLS_SEND`
  - `MINIOS_SYS_TLS_RECV` (macro, line 202) `#define MINIOS_SYS_TLS_RECV`
  - `MINIOS_SYS_TIME` (macro, line 203) `#define MINIOS_SYS_TIME`
  - `MINIOS_SYS_KBD` (macro, line 204) `#define MINIOS_SYS_KBD`
  - `MINIOS_SYS_PALETTE` (macro, line 205) `#define MINIOS_SYS_PALETTE`
  - `MINIOS_SYS_KBD_RAW` (macro, line 206) `#define MINIOS_SYS_KBD_RAW`
  - `MINIOS_SYS_VGA_MODE` (macro, line 207) `#define MINIOS_SYS_VGA_MODE`
  - `MINIOS_SYS_PCSPK_INIT` (macro, line 208) `#define MINIOS_SYS_PCSPK_INIT`
  - `MINIOS_SYS_PCSPK_TONE` (macro, line 209) `#define MINIOS_SYS_PCSPK_TONE`
  - `MINIOS_SYS_DOOM_FRAME` (macro, line 210) `#define MINIOS_SYS_DOOM_FRAME`
  - `MINIOS_SYS_RTC` (macro, line 211) `#define MINIOS_SYS_RTC`
  - `MINIOS_SYS_FB_INFO` (macro, line 212) `#define MINIOS_SYS_FB_INFO`
  - `MINIOS_SYS_PCSPK_VOL` (macro, line 213) `#define MINIOS_SYS_PCSPK_VOL`
  - `MINIOS_SYS_SPAWN` (macro, line 214) `#define MINIOS_SYS_SPAWN`
  - `MINIOS_SYS_LZ4_COMPRESS` (macro, line 215) `#define MINIOS_SYS_LZ4_COMPRESS`
  - `MINIOS_SYS_LZ4_DECOMPRESS` (macro, line 216) `#define MINIOS_SYS_LZ4_DECOMPRESS`
  - `MINIOS_SYS_MOUSE` (macro, line 217) `#define MINIOS_SYS_MOUSE`
  - `MINIOS_SYS_NK_FRAME` (macro, line 218) `#define MINIOS_SYS_NK_FRAME`
  - `MINIOS_SYS_SB16_OPEN` (macro, line 219) `#define MINIOS_SYS_SB16_OPEN`
  - `MINIOS_SYS_SB16_SUBMIT` (macro, line 220) `#define MINIOS_SYS_SB16_SUBMIT`
  - `MINIOS_SYS_GFX_SET_TITLE` (macro, line 221) `#define MINIOS_SYS_GFX_SET_TITLE`
  - `MINIOS_SYS_SB16_PUMP` (macro, line 222) `#define MINIOS_SYS_SB16_PUMP`
  - `MINIOS_SYS_SB16_STREAM_OPEN` (macro, line 223) `#define MINIOS_SYS_SB16_STREAM_OPEN`
  - `MINIOS_SYS_SB16_STREAM_CLOSE` (macro, line 224) `#define MINIOS_SYS_SB16_STREAM_CLOSE`
  - `MINIOS_SYS_SB16_STREAM_SUBMIT` (macro, line 225) `#define MINIOS_SYS_SB16_STREAM_SUBMIT`
  - `MINIOS_SYS_SB16_STREAM_VOLUME` (macro, line 226) `#define MINIOS_SYS_SB16_STREAM_VOLUME`
  - `MINIOS_SYS_THREAD_SPAWN` (macro, line 227) `#define MINIOS_SYS_THREAD_SPAWN`
  - `MINIOS_SYS_FUTEX_WAIT` (macro, line 228) `#define MINIOS_SYS_FUTEX_WAIT`
  - `MINIOS_SYS_FUTEX_WAKE` (macro, line 229) `#define MINIOS_SYS_FUTEX_WAKE`
  - `MINIOS_SYS_SUBMIT_BATCH` (macro, line 230) `#define MINIOS_SYS_SUBMIT_BATCH`
  - `MINIOS_SYS_GETC_RAW` (macro, line 231) `#define MINIOS_SYS_GETC_RAW`
  - `MINIOS_SYS_GFX_PRESENT` (macro, line 232) `#define MINIOS_SYS_GFX_PRESENT`
  - `MINIOS_SYS_SECCOMP` (macro, line 233) `#define MINIOS_SYS_SECCOMP`
  - `MINIOS_SYS_NICE` (macro, line 234) `#define MINIOS_SYS_NICE`
  - `MINIOS_SYS_CLONE` (macro, line 235) `#define MINIOS_SYS_CLONE`
  - `MINIOS_GFX_BUF_GAME` (macro, line 244) `#define MINIOS_GFX_BUF_GAME`
  - `MINIOS_GFX_BUF_NK` (macro, line 245) `#define MINIOS_GFX_BUF_NK`
  - `MINIOS_SYS_FRAMEBUFFER_COMMIT` (macro, line 246) `#define MINIOS_SYS_FRAMEBUFFER_COMMIT`
  - `MINIOS_SYS_WINDOW_PRESENT` (macro, line 247) `#define MINIOS_SYS_WINDOW_PRESENT`
  - `MINIOS_SYS_WINDOW_TITLE` (macro, line 248) `#define MINIOS_SYS_WINDOW_TITLE`
  - `SYS_TIME_MS` (macro, line 251) `#define SYS_TIME_MS`
  - `SYS_PALETTE` (macro, line 252) `#define SYS_PALETTE`
  - `SYS_PCSPK_INIT` (macro, line 253) `#define SYS_PCSPK_INIT`
  - `SYS_PCSPK_TONE` (macro, line 254) `#define SYS_PCSPK_TONE`
  - `SYS_RTC` (macro, line 255) `#define SYS_RTC`
  - `SYS_FB_INFO` (macro, line 256) `#define SYS_FB_INFO`
  - `SYS_PCSPK_VOL` (macro, line 257) `#define SYS_PCSPK_VOL`
  - `SYS_SPAWN` (macro, line 258) `#define SYS_SPAWN`
  - `SYS_TIME` (macro, line 259) `#define SYS_TIME`
  - `SYS_WRITE` (macro, line 260) `#define SYS_WRITE`
  - `MINIOS_EABI_MISMATCH` (macro, line 263) `#define MINIOS_EABI_MISMATCH`
