...
- Symbols:
  ...
  - `MINIOS_USER_LOAD_BASE` (macro, line 91) `#define MINIOS_USER_LOAD_BASE`
  - `MINIOS_USER_LOAD_END` (macro, line 92) `#define MINIOS_USER_LOAD_END`
  - `MINIOS_USER_STACK_SIZE` (macro, line 93) `#define MINIOS_USER_STACK_SIZE`
  - `MINIOS_USER_STACK_TOP` (macro, line 94) `#define MINIOS_USER_STACK_TOP`
  - `MINIOS_USER_STACK_BASE` (macro, line 95) `#define MINIOS_USER_STACK_BASE`
  - `MINIOS_USER_BRK_END` (macro, line 96) `#define MINIOS_USER_BRK_END`
  - `MINIOS_DOOM_BACKBUF_ADDR` (macro, line 113) `#define MINIOS_DOOM_BACKBUF_ADDR`
  - `MINIOS_DOOM_W` (macro, line 114) `#define MINIOS_DOOM_W`
  - `MINIOS_DOOM_H` (macro, line 115) `#define MINIOS_DOOM_H`
  - `MINIOS_FB_ADDR` (macro, line 116) `#define MINIOS_FB_ADDR`
  - `MINIOS_NK_BACKBUF_ADDR` (macro, line 117) `#define MINIOS_NK_BACKBUF_ADDR`
  - `MINIOS_NK_W` (macro, line 118) `#define MINIOS_NK_W`
  - `MINIOS_NK_H` (macro, line 119) `#define MINIOS_NK_H`
  - `MINIOS_HEAP_BASE` (macro, line 124) `#define MINIOS_HEAP_BASE`
  - `MINIOS_HEAP_SIZE` (macro, line 125) `#define MINIOS_HEAP_SIZE`
  - `MINIOS_FB_WIDTH_MAX` (macro, line 130) `#define MINIOS_FB_WIDTH_MAX`
  - `MINIOS_FB_HEIGHT_MAX` (macro, line 131) `#define MINIOS_FB_HEIGHT_MAX`
  - `MINIOS_SYS_READ` (macro, line 149) `#define MINIOS_SYS_READ`
  - `MINIOS_SYS_WRITE` (macro, line 150) `#define MINIOS_SYS_WRITE`
  - `MINIOS_SYS_OPEN` (macro, line 151) `#define MINIOS_SYS_OPEN`
  - `MINIOS_SYS_CLOSE` (macro, line 152) `#define MINIOS_SYS_CLOSE`
  - `MINIOS_SYS_FSTAT` (macro, line 153) `#define MINIOS_SYS_FSTAT`
  - `MINIOS_SYS_POLL` (macro, line 154) `#define MINIOS_SYS_POLL`
  - `MINIOS_SYS_LSEEK` (macro, line 155) `#define MINIOS_SYS_LSEEK`
  - `MINIOS_SYS_MMAP` (macro, line 156) `#define MINIOS_SYS_MMAP`
  - `MINIOS_SYS_MPROTECT` (macro, line 157) `#define MINIOS_SYS_MPROTECT`
  - `MINIOS_SYS_MUNMAP` (macro, line 158) `#define MINIOS_SYS_MUNMAP`
  - `MINIOS_SYS_BRK` (macro, line 159) `#define MINIOS_SYS_BRK`
  - `MINIOS_SYS_RT_SIGACTION` (macro, line 160) `#define MINIOS_SYS_RT_SIGACTION`
  - `MINIOS_SYS_RT_SIGPROCMASK` (macro, line 161) `#define MINIOS_SYS_RT_SIGPROCMASK`
  - `MINIOS_SYS_IOCTL` (macro, line 162) `#define MINIOS_SYS_IOCTL`
  - `MINIOS_SYS_WRITEV` (macro, line 163) `#define MINIOS_SYS_WRITEV`
  - `MINIOS_SYS_ACCESS` (macro, line 164) `#define MINIOS_SYS_ACCESS`
  - `MINIOS_SYS_SCHED_YIELD` (macro, line 165) `#define MINIOS_SYS_SCHED_YIELD`
  - `MINIOS_SYS_GETPID` (macro, line 166) `#define MINIOS_SYS_GETPID`
  - `MINIOS_SYS_SOCKET` (macro, line 167) `#define MINIOS_SYS_SOCKET`
  - `MINIOS_SYS_CONNECT` (macro, line 168) `#define MINIOS_SYS_CONNECT`
  - `MINIOS_SYS_SENDTO` (macro, line 169) `#define MINIOS_SYS_SENDTO`
  - `MINIOS_SYS_RECVFROM` (macro, line 170) `#define MINIOS_SYS_RECVFROM`
  - `MINIOS_SYS_SHUTDOWN` (macro, line 171) `#define MINIOS_SYS_SHUTDOWN`
  - `MINIOS_SYS_FORK` (macro, line 172) `#define MINIOS_SYS_FORK`
  - `MINIOS_SYS_VFORK` (macro, line 173) `#define MINIOS_SYS_VFORK`
  - `MINIOS_SYS_EXECVE` (macro, line 174) `#define MINIOS_SYS_EXECVE`
  - `MINIOS_SYS_EXIT` (macro, line 175) `#define MINIOS_SYS_EXIT`
  - `MINIOS_SYS_WAIT4` (macro, line 176) `#define MINIOS_SYS_WAIT4`
  - `MINIOS_SYS_KILL` (macro, line 177) `#define MINIOS_SYS_KILL`
  - `MINIOS_SYS_UNLINK` (macro, line 178) `#define MINIOS_SYS_UNLINK`
  - `MINIOS_SYS_READLINK` (macro, line 179) `#define MINIOS_SYS_READLINK`
  - `MINIOS_SYS_GETTID` (macro, line 180) `#define MINIOS_SYS_GETTID`
  - `MINIOS_SYS_FLOCK` (macro, line 181) `#define MINIOS_SYS_FLOCK`
  - `MINIOS_SYS_GETCWD` (macro, line 182) `#define MINIOS_SYS_GETCWD`
  - `MINIOS_SYS_GETTIMEOFDAY` (macro, line 183) `#define MINIOS_SYS_GETTIMEOFDAY`
  - `MINIOS_SYS_ARCH_PRCTL` (macro, line 184) `#define MINIOS_SYS_ARCH_PRCTL`
  - `MINIOS_SYS_OPENAT` (macro, line 185) `#define MINIOS_SYS_OPENAT`
  - `MINIOS_SYS_NEWFSTATAT` (macro, line 186) `#define MINIOS_SYS_NEWFSTATAT`
  - `MINIOS_SYS_READLINK` (macro, line 187) `#define MINIOS_SYS_READLINK`
  - `MINIOS_SYS_STATX` (macro, line 188) `#define MINIOS_SYS_STATX`
  - `MINIOS_SYS_SET_MEMPOLICY` (macro, line 189) `#define MINIOS_SYS_SET_MEMPOLICY`
  - `MINIOS_SYS_SET_ROBUST_LIST` (macro, line 190) `#define MINIOS_SYS_SET_ROBUST_LIST`
  - `MINIOS_SYS_PRLIMIT64` (macro, line 191) `#define MINIOS_SYS_PRLIMIT64`
  - `MINIOS_SYS_GETRANDOM` (macro, line 192) `#define MINIOS_SYS_GETRANDOM`
  - `MINIOS_SYS_RSEQ` (macro, line 193) `#define MINIOS_SYS_RSEQ`
  - `MINIOS_SYS_EXIT_GROUP` (macro, line 194) `#define MINIOS_SYS_EXIT_GROUP`
  - `MINIOS_SYS_SET_TID_ADDRESS` (macro, line 195) `#define MINIOS_SYS_SET_TID_ADDRESS`
