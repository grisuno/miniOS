...
- `kernel.h` (score: 137.00)
- `kernel/string.c` (score: 117.30)
...
- `progs/doomgeneric/d_main.c` -- complexity: 0.4, centrality: 0.8, combined: 0.6
- `progs/doomgeneric/g_game.c` -- complexity: 0.3, centrality: 0.7, combined: 0.5
- `kernel/syscalls.c` -- complexity: 0.5, centrality: 0.5, combined: 0.5
- `progs/doomgeneric/st_stuff.c` -- complexity: 0.5, centrality: 0.4, combined: 0.5
...
- `kernel/shell.c` -- complexity: 0.4, centrality: 0.3, combined: 0.4
- `progs/doomgeneric/d_englsh.h` -- complexity: 0.9, centrality: 0.0, combined: 0.4
- `sched.h` -- complexity: 0.3, centrality: 0.4, combined: 0.4
