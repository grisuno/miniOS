...
| `kernel/syscalls.c` | syscalls.c - Linux x86-64 syscall dispatcher and SYS_SPAWN. | kernel | 143 |
...
| `progs/doomgeneric/d_iwad.c` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 35 |
| `progs/doomgeneric/d_iwad.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 14 |
| `progs/doomgeneric/d_loop.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 36 |
| `progs/doomgeneric/d_loop.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 13 |
| `progs/doomgeneric/d_main.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 113 |
...
| `progs/doomgeneric/d_mode.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 7 |
| `progs/doomgeneric/d_net.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 17 |
...
| `progs/doomgeneric/d_think.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 5 |
| `progs/doomgeneric/d_ticcmd.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 1993-2008 Raven Software C | doomgeneric | 2 |
| `progs/doomgeneric/deh_main.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 13 |
...
| `progs/doomgeneric/doomgeneric.c` | include "doomgeneric.h" | doomgeneric | 2 |
| `progs/doomgeneric/doomgeneric.h` | ifndef DOOM_GENERIC define DOOM_GENERIC  include <stdlib.h> include <stdint.h>   | doomgeneric | 10 |
| `progs/doomgeneric/doomgeneric_minios.c` | doomgeneric_minios.c - MiniOS platform layer for doomgeneric. | doomgeneric | 31 |
| `progs/doomgeneric/doomgeneric_sdl.c` | doomgeneric for soso os  include "doomkeys.h" include "m_argv.h" include "doomge | doomgeneric | 20 |
| `progs/doomgeneric/doomgeneric_soso.c` | doomgeneric for soso os  include "doomkeys.h" include "m_argv.h" include "doomge | doomgeneric | 23 |
| `progs/doomgeneric/doomgeneric_sosox.c` | doomgeneric for soso os (nano-x version) TODO: get keys from X, not using direct | doomgeneric | 29 |
| `progs/doomgeneric/doomgeneric_win.c` | include "doomkeys.h"  include "doomgeneric.h"  include <stdio.h>  include <Windo | doomgeneric | 26 |
| `progs/doomgeneric/doomgeneric_xlib.c` | include "doomkeys.h"  include "doomgeneric.h"  include <ctype.h> include <stdio. | doomgeneric | 21 |
...
| `progs/doomgeneric/f_finale.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 24 |
| `progs/doomgeneric/f_finale.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 5 |
| `progs/doomgeneric/f_wipe.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 15 |
| `progs/doomgeneric/f_wipe.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 4 |
| `progs/doomgeneric/g_game.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 97 |
| `progs/doomgeneric/g_game.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 24 |
| `progs/doomgeneric/gusconf.c` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 17 |
| `progs/doomgeneric/gusconf.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 4 |
| `progs/doomgeneric/hu_lib.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 24 |
| `progs/doomgeneric/hu_lib.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 27 |
| `progs/doomgeneric/hu_stuff.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 37 |
| `progs/doomgeneric/hu_stuff.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 18 |
| `progs/doomgeneric/i_cdmus.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 1993-2008 Raven Software   | doomgeneric | 11 |
| `progs/doomgeneric/i_cdmus.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 1993-2008 Raven Software   | doomgeneric | 18 |
| `progs/doomgeneric/i_endoom.c` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 10 |
| `progs/doomgeneric/i_endoom.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 2 |
| `progs/doomgeneric/i_input.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 6 |
| `progs/doomgeneric/i_joystick.c` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 20 |
...
| `progs/doomgeneric/i_main.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 5 |
| `progs/doomgeneric/i_minios_sound.c` | include <stdio.h> include <stdlib.h> include <string.h> include "doomtype.h" inc | doomgeneric | 45 |
| `progs/doomgeneric/i_scale.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 45 |
| `progs/doomgeneric/i_scale.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 18 |
| `progs/doomgeneric/i_sound.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 35 |
| `progs/doomgeneric/i_sound.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 35 |
| `progs/doomgeneric/i_swap.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 8 |
| `progs/doomgeneric/i_system.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 46 |
| `progs/doomgeneric/i_system.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 15 |
| `progs/doomgeneric/i_timer.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 8 |
| `progs/doomgeneric/i_timer.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 7 |
| `progs/doomgeneric/i_video.c` | Emacs style mode select   -*- C++ -*- ------------------------------------------ | doomgeneric | 37 |
| `progs/doomgeneric/i_video.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 43 |
...
| `progs/doomgeneric/m_argv.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 12 |
| `progs/doomgeneric/m_argv.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 8 |
...
| `progs/doomgeneric/m_cheat.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 3 |
| `progs/doomgeneric/m_cheat.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 7 |
| `progs/doomgeneric/m_config.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 1993-2008 Raven Software C | doomgeneric | 34 |
| `progs/doomgeneric/m_config.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 13 |
| `progs/doomgeneric/m_controls.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 1993-2008 Raven Software C | doomgeneric | 11 |
...
| `progs/doomgeneric/m_menu.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 88 |
| `progs/doomgeneric/m_menu.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 8 |
| `progs/doomgeneric/m_misc.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 1993-2008 Raven Software C | doomgeneric | 34 |
| `progs/doomgeneric/m_misc.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 21 |
...
| `progs/doomgeneric/memio.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 12 |
| `progs/doomgeneric/memio.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 10 |
| `progs/doomgeneric/net_client.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 23 |
...
| `progs/doomgeneric/net_defs.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 30 |
| `progs/doomgeneric/net_gui.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 2 |
| `progs/doomgeneric/net_io.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 10 |
| `progs/doomgeneric/net_loop.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 3 |
| `progs/doomgeneric/net_packet.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 15 |
| `progs/doomgeneric/net_query.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 13 |
...
| `progs/doomgeneric/p_ceilng.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 9 |
| `progs/doomgeneric/p_doors.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 14 |
| `progs/doomgeneric/p_enemy.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 83 |
| `progs/doomgeneric/p_floor.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 12 |
| `progs/doomgeneric/p_inter.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 15 |
| `progs/doomgeneric/p_inter.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 2 |
| `progs/doomgeneric/p_lights.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 12 |
| `progs/doomgeneric/p_local.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 101 |
| `progs/doomgeneric/p_map.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard, An | doomgeneric | 39 |
| `progs/doomgeneric/p_maputl.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard Cop | doomgeneric | 20 |
| `progs/doomgeneric/p_mobj.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 33 |
| `progs/doomgeneric/p_mobj.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 3 |
| `progs/doomgeneric/p_plats.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 10 |
| `progs/doomgeneric/p_pspr.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 43 |
| `progs/doomgeneric/p_pspr.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 4 |
| `progs/doomgeneric/p_saveg.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 72 |
| `progs/doomgeneric/p_saveg.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 18 |
| `progs/doomgeneric/p_setup.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 33 |
| `progs/doomgeneric/p_setup.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 3 |
| `progs/doomgeneric/p_sight.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 6 |
| `progs/doomgeneric/p_spec.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 57 |
| `progs/doomgeneric/p_spec.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 96 |
| `progs/doomgeneric/p_switch.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 10 |
| `progs/doomgeneric/p_telept.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 2 |
| `progs/doomgeneric/p_tick.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 9 |
| `progs/doomgeneric/p_tick.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 2 |
| `progs/doomgeneric/p_user.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 12 |
| `progs/doomgeneric/r_bsp.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 12 |
| `progs/doomgeneric/r_bsp.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 21 |
| `progs/doomgeneric/r_data.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 27 |
...
| `progs/doomgeneric/r_draw.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 27 |
...
| `progs/doomgeneric/r_main.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 35 |
| `progs/doomgeneric/r_main.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 36 |
| `progs/doomgeneric/r_plane.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 14 |
| `progs/doomgeneric/r_plane.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 16 |
| `progs/doomgeneric/r_segs.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 9 |
...
| `progs/doomgeneric/r_things.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 23 |
| `progs/doomgeneric/r_things.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 22 |
| `progs/doomgeneric/s_sound.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 42 |
| `progs/doomgeneric/s_sound.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 16 |
| `progs/doomgeneric/sha1.c` | sha1.c - SHA1 hash function | doomgeneric | 23 |
...
| `progs/doomgeneric/st_lib.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 13 |
| `progs/doomgeneric/st_lib.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 14 |
| `progs/doomgeneric/st_stuff.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 158 |
| `progs/doomgeneric/st_stuff.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 20 |
| `progs/doomgeneric/statdump.c` | - | doomgeneric | 15 |
...
| `progs/doomgeneric/v_video.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 1993-2008 Raven Software C | doomgeneric | 49 |
| `progs/doomgeneric/v_video.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 28 |
| `progs/doomgeneric/w_checksum.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 8 |
...
| `progs/doomgeneric/w_file.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 9 |
| `progs/doomgeneric/w_file_stdc.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 8 |
| `progs/doomgeneric/w_main.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 6 |
| `progs/doomgeneric/w_main.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 2 |
| `progs/doomgeneric/w_merge.h` | Copyright(C) 2005-2014 Simon Howard  This program is free software; you can redi | doomgeneric | 7 |
| `progs/doomgeneric/w_wad.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 30 |
| `progs/doomgeneric/w_wad.h` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 17 |
| `progs/doomgeneric/wi_stuff.c` | Copyright(C) 1993-1996 Id Software, Inc. Copyright(C) 2005-2014 Simon Howard  Th | doomgeneric | 79 |
...
| `progs/minios_abi.h` | ifndef MINIOS_ABI_H define MINIOS_ABI_H  minios_abi.h -- Single source of truth  | misc | 125 |
...
| `progs/nuklear/nuklear_minios.h` | ifndef NUKLEAR_MINIOS_H define NUKLEAR_MINIOS_H  nuklear_minios.h — MiniOS platf | nuklear | 24 |
...
| `progs/src/kmem.c` | Kernel-pointer rejection probe. Passes a supervisor-only address | src | 4 |
| `progs/src/ldhello.c` | - | src | 1 |
| `progs/src/lxhello.c` | - | src | 9 |
...
| `progs/src/mmreuse.c` | mmap/munmap reclaim stress test.  Repeatedly maps and unmaps a large | src | 6 |
...
| `progs/vedit/vedit.c` | vedit IDE build and run contract. | misc | 147 |
...
| `vga_fb.h` | ifndef VGA_FB_H define VGA_FB_H  include <stdint.h> include "minios_abi.h"  Fram | root | 113 |
