...
[LazyOwn](https://github.com/grisuno/LazyOwn) [RedTeam](https://medium.com/@lazyown.redteam) has released an educational 64-bit x86 teaching kernel and operating system, with basic security, and that carries its own complete toolchain of a subset of C, micropython, lua, and lisp, You can write a C
