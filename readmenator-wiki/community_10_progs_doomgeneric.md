...
*Community 10 | 175 files | cohesion 0.95*
...
- [dataflow UNCHECKED_ALLOC] `progs/doomgeneric/m_config.c:2099` `M_GetSaveGameDir` `savegamedir`: Result of allocator stored in `savegamedir` is never checked against NULL.
